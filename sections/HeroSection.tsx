...
export default function HeroSection() {
    const highlights = [
        "Hosted on Codeforces",
        "₹1.5+ lakh prize pool",
        "160+ teams nationwide",
    ];
        ...
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            >
                ...
                <p className="flex items-center gap-1">
                    <span>National-Level Competitive Programming Contest</span>
            ...
            >
                Welcome to{" "}
                <span className="move-gradient px-3 rounded-xl text-nowrap">K³</span>
            </motion.h1>
            <motion.p className="text-base text-center text-slate-200 max-w-lg mt-6"
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                An offline national-level competitive programming contest by IIIT Kottayam — 40 home teams, 120+ visiting teams, three intense rounds.
            </motion.p>
            ...
            >
                <a href="#contact" className="bg-pink-600 hover:bg-pink-700 text-white rounded-full px-7 h-11 flex items-center">
                    Register Now
                </a>
                <a href="#timeline" className="flex items-center gap-2 border border-pink-900 hover:bg-pink-950/50 transition rounded-full px-6 h-11">
