...
const contacts = [
    { name: "Vibhaas Srivastava", role: "Lead Organizer", email: "vibhaas23bcs37@iiitkottayam.ac.in", phone: "+91 8281497823", image: "https://api.dicebear.com/9.x/notionists/svg?seed=Vibhaas" },
    { name: "Devnarayan P S", role: "Organizer", email: "devnarayans24bcs0209@iiitkottayam.ac.in", phone: "+91 9567479064", image: "https://api.dicebear.com/9.x/notionists/svg?seed=Devnarayan" },
    { name: "Pranathi T R", role: "Organizer", email: "pranathir24bcs69@iiitkottayam.ac.in", phone: "+91 9986044961", image: "https://api.dicebear.com/9.x/notionists/svg?seed=Pranathi" },
    { name: "Sarah Mariam Sunil", role: "Organizer", email: "sarahsunil24bcs04@iiitkottayam.ac.in", phone: "+91 8921398452", image: "https://api.dicebear.com/9.x/notionists/svg?seed=Sarah" },
];
                ...
                {contacts.map((person, index) => (
                    ...
                    >
                        ...
                        <div className="absolute inset-x-0 bottom-0 p-4 z-10">
                            ...
                            <div className="rounded-full p-[1px] w-max mt-1.5"
                                style={{ background: 'linear-gradient(90deg, rgb(105, 51, 0) 0%, rgb(128, 30, 0) 32.88%, rgb(0, 0, 0) 54.05%, rgb(0, 105, 166) 100%)' }}
                            >
                                <span className="text-[11px] text-white/80 bg-black/80 backdrop-blur-sm rounded-full px-2.5 py-0.5 block">{person.role}</span>
                            </div>
                        </div>
                        ...
                        <div className="absolute inset-0 z-20 flex flex-col justify-center items-center p-5 bg-slate-950/90 backdrop-blur-sm opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 ease-out">
                            ...
                            <div className="rounded-full p-[1px] w-max mt-1"
                                style={{ background: 'linear-gradient(90deg, rgb(105, 51, 0) 0%, rgb(128, 30, 0) 32.88%, rgb(0, 0, 0) 54.05%, rgb(0, 105, 166) 100%)' }}
                            >
                                <span className="text-[10px] text-white/80 bg-black rounded-full px-2.5 py-0.5 block">{person.role}</span>
                            </div>
