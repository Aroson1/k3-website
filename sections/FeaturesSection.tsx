...
const timelineEvents = [
    {
        ...
        description: "Team registrations open for all colleges across India. IIIT Kottayam students register free; outside teams for ₹200.",
    ...
    },
    {
        ...
        description: "Last day to register your team. Ensure all team members are confirmed before the deadline.",
    ...
    },
    {
        ...
        description: "Identify and fix bugs in incorrect code  test your precision and eye for detail. Top teams advance.",
    ...
    },
    {
        ...
        description: "Deduce the underlying logic solely from sample outputs  challenge your analytical thinking.",
    ...
    },
    {
        ...
        description: "Go head-to-head against the best  the fastest team to solve wins the championship.",
    ...
    },
    {
        ...
        description: "Winners announced, prizes distributed, and closing ceremony with sponsors and guests.",
...
export default function FeaturesSection() {
    return (
        <div id="timeline" className="py-16 px-4 md:px-16 lg:px-24 xl:px-32 relative">
            ...
            <SectionTitle text1="Event" text2="Contest Timeline" text3="Key dates and milestones  from registration to the grand finale." />
                    ...
                    >
                        ...
                        <div className="flex-1 pb-2">
                            <div className="flex flex-wrap items-center gap-2 mb-1.5">
                                <span className="rounded-full p-[1px] inline-block" style={{ background: 'linear-gradient(90deg, rgb(105, 51, 0) 0%, rgb(128, 30, 0) 32.88%, rgb(0, 0, 0) 54.05%, rgb(0, 105, 166) 100%)' }}>
                            ...
                            <h3 className="text-lg font-semibold text-white group-hover:text-pink-100 transition-colors">{event.title}</h3>
            ...
            {/* Registration info */}
            <motion.div className="max-w-3xl mx-auto mt-14 relative group"
