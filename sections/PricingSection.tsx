...
export default function PricingSection() {
  return (
    <div id="pricing" className="px-4 md:px-16 lg:px-24 xl:px-32 relative">
      ...
      <SectionTitle
        text1="Sponsors"
        text2="Sponsorship Tiers"
        text3="Partner with K³  get direct visibility among 160+ top student coders from across India."
      />
      ...
      <div className="flex flex-wrap items-stretch justify-center gap-6 mt-20 max-w-5xl mx-auto">
        {pricingData.map((plan: IPricing, index: number) => (
          ...
          >
            ...
            <div
              className={`relative h-full flex flex-col p-7 rounded-2xl ${
            ...
            >
              ...
              <a
                href="#contact"
                className={`block text-center w-full py-3 rounded-xl font-medium mt-7 transition-all duration-300 ${
                  plan.mostPopular
