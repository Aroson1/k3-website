...
export default function FeatureAnimation() {
  return (
    <motion.div
      ...
      className="flex flex-wrap items-center justify-center gap-3 mt-16 max-w-4xl mx-auto"
    >
      {stats.map((stat, index) => (
        ...
        >
          <div className="flex items-center gap-3 bg-black rounded-2xl px-5 py-3 hover:bg-white/[0.02] transition-colors cursor-default">
            <div className="relative w-8 h-8 flex items-center justify-center rounded-lg text-pink-400">
