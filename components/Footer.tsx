...
export default function Footer() {
    return (
        <footer className="flex flex-wrap justify-center md:justify-between overflow-hidden gap-10 md:gap-20 mt-40 py-6 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500">
            ...
            >
                <a href="/">
                    <Image className="size-8 aspect-square" src="/assets/footer-logo.svg" alt="K³ logo" width={32} height={32} priority />
                </a>
            ...
            <motion.div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end"
                ...
                transition={{ type: "spring", stiffness: 280, damping: 70, mass: 1 }}
            >
                <p className="max-w-60">Bringing the nation’s best competitive programmers together — March 21–22, 2026.</p>
                ...
                <p className="mt-3 text-center">&copy; {new Date().getFullYear()} K³ — Coders&#39; Club, IIIT Kottayam</p>
            </motion.div>
        </footer>
    );
}